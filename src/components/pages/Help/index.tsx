    ...
    >
      ...
      >
        ...
        <Input
          ...
          className="bg-white w-2/3 mt-auto"
        />
            ...
            <Stack component="form" width="100%" gap="10px">
              ...
              <Button fullWidth $variant={'secondary'} onClick={handleEmail}>
                <Stack sx={{ flexDirection: 'row', justifyContent: 'space-between', width: '100%' }}>
                  <Text>{t('helpTicket.email')}</Text>
                  <Text>{'>'}</Text>
                </Stack>
              </Button>
              <Button fullWidth $variant={'secondary'} onClick={handlePassword}>
                <Stack sx={{ flexDirection: 'row', justifyContent: 'space-between', width: '100%' }}>
                  <Text>{t('helpTicket.password')}</Text>
                  <Text>{'>'}</Text>
                </Stack>
              </Button>
              <Button fullWidth $variant={'secondary'} onClick={handlePremium}>
                <Stack sx={{ flexDirection: 'row', justifyContent: 'space-between', width: '100%' }}>
                  <Text>{t('helpTicket.premium')}</Text>
                  <Text>{'>'}</Text>
                </Stack>
              </Button>
              <Button fullWidth $variant={'secondary'} onClick={handleCloseAccount}>
                <Stack sx={{ flexDirection: 'row', justifyContent: 'space-between', width: '100%' }}>
                  <Text>{t('helpTicket.closeAccount')}</Text>
                  <Text>{'>'}</Text>
                </Stack>
              </Button>
              <Button fullWidth $variant={'secondary'} onClick={handleVisibility}>
                <Stack sx={{ flexDirection: 'row', justifyContent: 'space-between', width: '100%' }}>
                  <Text>{t('helpTicket.visibility')}</Text>
                  <Text>{'>'}</Text>
                </Stack>
              </Button>
              <TextField
                ...
                inputProps={{
                  endAdornment: <InputAdornment position="end">
                    <IconButton onClick={() => handleQuestion({ question: question })}>
