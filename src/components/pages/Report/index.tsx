...
export const Report = () => {
  ...
  const handleReportForm = (category: string) => {
  ...
  const handleQuestion = (question: string) => {
    ...
    >
      ...
      >
        ...
        <Stack gap={1}>
          <Button fullWidth $variant="transparent" onClick={() => handleReportForm('pages')} >{t('report.buttons.pages')}</Button>
          <Button fullWidth $variant="transparent" onClick={() => handleReportForm('groups')} >{t('report.buttons.groups')}</Button>
          <Button fullWidth $variant="transparent" onClick={() => handleReportForm('profile')} >{t('report.buttons.profile')}</Button>
          <Button fullWidth $variant="transparent" onClick={() => handleReportForm('safety')} >{t('report.buttons.safety')}</Button>
          <Button fullWidth $variant="transparent" onClick={() => handleReportForm('messaging')} >{t('report.buttons.messaging')}</Button>
          <Button fullWidth $variant="transparent" onClick={() => handleReportForm('premium')} >{t('report.buttons.premium')}</Button>
          <Button fullWidth $variant="transparent" onClick={() => handleReportForm('other')} >{t('report.buttons.other')}</Button>
        </Stack>
        ...
        >
          ...
          >
            <Stack component="form" width="100%" gap="10px">
              ...
              <TextField
                ...
                inputProps={{
                  endAdornment: <InputAdornment position="end">
                    <IconButton onClick={() => handleQuestion(question)}>
